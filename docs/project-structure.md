...
- **익명성**: 인게임에서는 동물 닉네임 사용 (20개 미리 정의)
  - ⚠️ **중요**: 게임 플레이 중에는 절대 userId나 실제 nickname을 노출하면 안됨
  - playerId(0-19)와 ANIMAL_NICKNAMES[playerId]만 사용
  - 시스템 메시지, 채팅, UI 표시 등 모든 곳에서 동물 닉네임 사용
  - 예외: 게임 종료 후 결과 화면에서만 실제 닉네임 사용
...
- **진단/치료**: 진단키트, 응급치료제
- **통신**: 무전기, 마이크
- **백신**: 백신재료 3종 (항바이러스혈청, 촉매정제물질, 신경억제단백질)
- **공격**: 좀비사살용산탄총
- **기타**: 낙서스프레이, 지우개
