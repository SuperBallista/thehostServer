...
프로젝트는 UI/UX와 아이템 사용 메서드는 구현되었으나, 핵심 턴 기반 게임 로직들이 미구현 상태입니다. 

특히 다음 핵심 기능들이 빠져 있어 실제 게임 진행이 불가능합니다:
- 2턴마다 1명 감염 시스템
- 감염 후 5턴 뒤 좀비 변이
- 좀비 5턴마다 이동
...
이러한 핵심 로직들을 구현해야 MVP로서 테스트 가능한 수준이 될 것으로 예상됩니다.